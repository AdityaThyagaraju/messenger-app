...
//           }
//         });
//         conversation.current = localConversation
//       }
//     }
...
//     if(user!=null && conversation.current==null){
//       getConversations();
//     }
    
//     if (conversation.current) {
      
//       if(conversation.current.chatIds)
//         getChats(conversation.current.chatIds);
//       let messenger = new Messenger(user, receiveChat);
//       setMessenger(messenger);
//       const { user1Id, user2Id } = conversation.current;
...
//       selected={conversation.current?conversation.current.id:-1}
